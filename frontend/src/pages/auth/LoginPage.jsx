...
import { Brain, GraduationCap, BookOpen, Mail, Lock, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050816] flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">AI-Powered Learning Analytics</p>
        </div>
        ...
        >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 text-slate-500 text-xs" style={{ background: 'transparent' }}>New to StudyAgent?</span>
            </div>
          </div>
          ...
          <Link
            to="/register"
            className="block w-full py-3 px-4 text-center btn-secondary font-semibold"
          >
            Create Account
          </Link>
        </motion.div>
